            ...
            <div className="events-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {events.map(event => (
                  <Link
                      ...
                      key={event.event_id}
                      className="event-card block bg-white border border-gray-200 rounded-xl p-5 shadow-sm transition-all duration-300 transform hover:shadow-lg hover:scale-105"
                  ...
                  >
                    ...
                    <div className="space-y-1 text-sm text-gray-700">
                      <div>{formatDate(event.start_time)}{event.end_time && ` - ${formatDate(event.end_time)}`}</div>
